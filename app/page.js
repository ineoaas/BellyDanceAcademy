    ...
    <main className="flex-1">
        ...
        <div className="max-w-5xl mx-auto px-6 pt-14 pb-14 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex gap-4 flex-wrap">
              ...
              <Button href="/login?as=instructor" variant="outlineLight">Teach With Us</Button>
            </div>
            <div className="flex gap-8 mt-9 pt-5 border-t border-gold/30">
              <Stat value="120+" label="Courses" />
              <Stat value="48" label="Instructors" />
              <Stat value="15,000+" label="Students" />
            </div>
          </div>
          <div className="flex justify-center">
            <div className="medallion w-56 h-56 md:w-64 md:h-64">
              <Image src="/logo.png" alt="Belly Dance Academy seal" width={256} height={256} />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex gap-8 overflow-x-auto pb-4">
            {INSTRUCTORS.map((i, idx) => (
              ...
              >
                ...
                <strong className="block font-display text-base">{i.name}</strong>
                <span className="text-sm text-ink/60">{i.city}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="pb-14">
        <div className="max-w-xl mx-auto px-8 text-center">
          ...
          <p className="font-display italic text-xl mb-3">
            I&apos;d taken in-studio classes for years and still learned things in week one.
            Amara teaches the way she performs, with total precision.
          </p>
          <cite className="text-xs uppercase tracking-widest text-ink/60 not-italic">
            — Nadia K., Student since 2025
          </cite>
        </div>
      </section>

      {/* CTA */}
      <section className="bg-burgundy-deep text-ivory text-center py-16">
        <div className="max-w-lg mx-auto px-6">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Button href="/login?as=instructor" variant="primary">Start Teaching</Button>
